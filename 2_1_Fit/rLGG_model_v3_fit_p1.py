...
# Fit of patient 1 volumetric data
...
# volume vector
data_volume = data.volume[:-2]
# time vector
data_time = convert_date_to_days(data.date)[:-2]
# y0
...
# Final plot 
plot_fit(t_global, Y_global, data_time, data_volume, treatment, p_id, save_img=True, ylim=260)
