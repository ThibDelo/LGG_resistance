...
# Fit of patient 4 volumetric data
...
# param search space
bounds = ((5e-4, 0.01), (1e-3, 0.02), (1e-2, 0.1), (0.1, 1), (0.15, 0.6), (0.15/10, 0.6/3))
...
# Final plot 
plot_fit(t_global, Y_global, data_time, data_volume, treatment, p_id, save_img=True, ylim=170)
